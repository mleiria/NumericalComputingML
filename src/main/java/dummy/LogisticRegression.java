...
import pt.mleiria.machinelearning.functions.SoftMax;
...
public class LogisticRegression {
    ...
    public Double[] output(double[] x) {
        ...
        OneVarFunction<Double[]> softmax = new SoftMax();
        return softmax.value(preActivation);
    ...
    public static void main(String[] args) {
        ...
        Gaussian g1 = new Gaussian(-2.0, 1.0, Optional.of(rng));
        Gaussian g2 = new Gaussian(2.0, 1.0, Optional.of(rng));
        Gaussian g3 = new Gaussian(0.0, 1.0, Optional.of(rng));
