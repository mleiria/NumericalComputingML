...
public class ScatterFactory extends ApplicationFrame {
     ...
     *
     * @param title
     * @param x the original xAxis points
     * @param y the original data. This will be plotted as points
     */
    ...
    public void buildPlot() {
        ...
        JFreeChart chart = createXYLineChart(title, xLabel, yLabel, datasetCollection, VERTICAL,
                true, false, false);
