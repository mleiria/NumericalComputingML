...
public class Matrix {
    ...
    /**
     * @return DhbMatrixAlgebra.DhbMatrix	inverse of the receiver or
     * pseudoinverse if the receiver is not a square matrix.
    ...
    /**
     * @return DhbMatrixAlgebra.SymmetricMatrix	the transposed product of the
     ...
     * @exception MatrixAlgebra.DhbIllegalDimension If the number of rows of the
     * receiver are not equal to the number of rows of the supplied matrix.
     */
